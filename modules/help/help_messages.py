...
HELP_HOME_TITLE = "Help"

HELP_HOME_DESCRIPTION = (
    "Welcome! This guide explains how to use the bot.\n\n"
...
GETTING_STARTED_DESCRIPTION = (
    ...
    "You can use the bot directly from Discord without "
    "needing to set anything up first."
)
...
SPRINTS_DESCRIPTION = (
    ...
    "**Joining**\n\n"
    "Press **Join** and choose one of your projects.\n\n"
    "You can:\n"
    "• Select an existing project\n"
    "• Create a new project\n"
    "• Use your last sprint project\n\n"
    "Your project's current word count will be used as your "
    "starting word count.\n\n"
    "**During the sprint**\n\n"
    "You can leave the sprint or use **Edit Sprint Activity** "
